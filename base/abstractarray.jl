...
# To make extension easier, limit the specializations of checkbounds on
# the types of the indices to only one situation: logical indexing with a single index.
"""
